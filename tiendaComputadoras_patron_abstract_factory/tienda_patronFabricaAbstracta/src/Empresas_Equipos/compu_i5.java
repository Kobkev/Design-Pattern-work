 ...
 */
public class compu_i5 extends Computadora{

    componentes_computadorasFactory computadoraFactory;
    String option;
    
    public compu_i5(componentes_computadorasFactory computadoraFactory, String option) {
    ...
    public void fabricacion() {
        ...
        procesador = computadoraFactory.crearProcesador(option);
        memoriaram = computadoraFactory.crearMemoriaRAM();
        disco = computadoraFactory.crearDisco("256 GB"); //se deja por default porque asi esta establecido no tiene mas opciones para este equipo
